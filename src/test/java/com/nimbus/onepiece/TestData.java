...
public class TestData {
    ...
    public static final List<CharacterRecord> CHARACTER_ALL = List.of(CHARACTER_LUFFY, CHARACTER_ZORO, CHARACTER_NAMI, CHARACTER_USOPP, CHARACTER_SANJI, CHARACTER_CHOPPER, CHARACTER_ROBIN, CHARACTER_FRANKY, CHARACTER_BROOK, CHARACTER_JINBE);
